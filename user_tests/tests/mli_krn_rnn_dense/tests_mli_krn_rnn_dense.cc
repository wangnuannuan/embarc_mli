...
static const rnn_dense_test_operands tests_list[] = {
    ...
    // Basic functionality test: Batch to Batch mode with TanH final activation
    {"Test 1 FX16 b-t-b TanH",         mli_krn_rnn_dense_fx16, 
                                       input_1_fx16, prev_out_1_fx16, weights_1_fx16, bias_1_fx16, test_1_out_fx16, test_1_cfg,
                                       thresholds_fx16_general, test_1_chksum_fx16},
    {"Test 1 FX16_FX8_FX8 b-t-b TanH", mli_krn_rnn_dense_fx16_fx8_fx8, 
                                       input_1_fx16, prev_out_1_fx16, weights_1_fx8, bias_1_fx8, test_1_out_fx16, test_1_cfg, 
                                       thresholds_fx16_fx8_fx8_general, test_1_chksum_fx16_fx8_fx8},
    {"Test 1 SA8_SA8_SA32 b-t-b TanH", mli_krn_rnn_dense_sa8_sa8_sa32,
                                       input_1_sa8, prev_out_1_sa8, weights_1_sa8, bias_1_sa32, test_1_out_sa8, test_1_cfg, 
                                       thresholds_sa8_general, test_1_chksum_sa8},

    // Basic functionality test: Batch to Last mode with TanH final activation
    {"Test 2 FX16 b-t-l TanH",         mli_krn_rnn_dense_fx16, 
                                       input_1_fx16, prev_out_1_fx16, weights_1_fx16, bias_1_fx16, test_2_out_fx16, test_2_cfg, 
                                       thresholds_fx16_general, test_2_chksum_fx16},
    {"Test 2 FX16_FX8_FX8 b-t-l TanH", mli_krn_rnn_dense_fx16_fx8_fx8,
                                       input_1_fx16, prev_out_1_fx16, weights_1_fx8, bias_1_fx8, test_2_out_fx16, test_2_cfg,
                                       thresholds_fx16_fx8_fx8_general, test_2_chksum_fx16_fx8_fx8},
    {"Test 2 SA8_SA8_SA32 b-t-l TanH", mli_krn_rnn_dense_sa8_sa8_sa32, 
                                       input_1_sa8, prev_out_1_sa8, weights_1_sa8, bias_1_sa32, test_2_out_sa8, test_2_cfg,
                                       thresholds_sa8_general, test_2_chksum_sa8},

    // Basic functionality test: One to One mode with TanH final activation
    {"Test 3 FX16 o-t-o TanH",         mli_krn_rnn_dense_fx16,
                                       input_2_fx16, prev_out_2_fx16, weights_1_fx16, bias_1_fx16, test_3_out_fx16, test_3_cfg,
                                       thresholds_fx16_general, test_3_chksum_fx16},
    {"Test 3 FX16_FX8_FX8 o-t-o TanH", mli_krn_rnn_dense_fx16_fx8_fx8,
                                       input_2_fx16, prev_out_2_fx16, weights_1_fx8, bias_1_fx8, test_3_out_fx16, test_3_cfg,
                                       thresholds_fx16_fx8_fx8_general, test_3_chksum_fx16_fx8_fx8},
    {"Test 3 SA8_SA8_SA32 o-t-o TanH", mli_krn_rnn_dense_sa8_sa8_sa32,
                                       input_2_sa8, prev_out_2_sa8, weights_1_sa8, bias_1_i2_w1_sa32, test_3_out_sa8, test_3_cfg,
                                       thresholds_sa8_general, test_3_chksum_sa8},
};

constexpr int kMemSize = 2780;
static IO_DATA_ATTR int8_t scratch_mem_in[kMemSize] = { 0 };
static IO_DATA_ATTR int8_t scratch_mem_prev_out[kMemSize] = { 0 };
...
int main() {
    ...
    for (int i = 0; i < kTestsNum; ++i) {
        ...
        if (!(cur_test->in.is_valid() && cur_test->prev_out.is_valid() && cur_test->weights.is_valid() &&
        ...
        mli_tensor prev_out = cur_test->prev_out.get_quantized_tensor(mem_prev_out_keeper.allocate_memory(cur_test->prev_out));
        ...
        if (is_test_passed &&
                (mem_in_keeper.is_memory_corrupted() || mem_prev_out_keeper.is_memory_corrupted() || mem_out_keeper.is_memory_corrupted() ||
        ...
        if (is_test_passed &&
                cur_test->mli_krn_rnn_dense(&input, &prev_out, &weights, &bias, &cur_test->cfg, &out) != MLI_STATUS_OK) {
